    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NWC_Default_Slice_Values_Code = table.Column<string>(type: "char(1)", nullable: false),
                    NWC_Default_Slice_Values_Name = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    ...
                    NWC_Default_Slice_Values_Reasons = table.Column<string>(type: "nvarchar(100)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NWC_Rreal_Estate_Types_Code = table.Column<string>(type: "char(1)", nullable: false),
                    NWC_Rreal_Estate_Types_Name = table.Column<string>(type: "nvarchar(15)", nullable: false),
                    NWC_Rreal_Estate_Types_Reasons = table.Column<string>(type: "nvarchar(100)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NWC_Subscriber_File_Id = table.Column<string>(type: "char(10)", nullable: false),
                    NWC_Subscriber_File_Name = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    NWC_Subscriber_File_City = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    NWC_Subscriber_File_Area = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    NWC_Subscriber_File_Mobile = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    NWC_Subscriber_File_Reasons = table.Column<string>(type: "nvarchar(100)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NWC_Subscription_File_No = table.Column<string>(type: "char(10)", nullable: false),
                    ...
                    NWC_Subscription_File_Reasons = table.Column<string>(type: "nvarchar(100)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NWC_Subscription_File", x => x.NWC_Subscription_File_No);
                    table.ForeignKey(
                        name: "FK_NWC_Subscription_File_NWC_Rreal_Estate_Types_NWC_Subscription_File_Rreal_Estate_Types_Code",
                    ...
                    table.ForeignKey(
                        name: "FK_NWC_Subscription_File_NWC_Subscriber_File_NWC_Subscription_File_Subscriber_Code",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NWC_Invoices_No = table.Column<string>(type: "char(10)", nullable: false),
                    NWC_Invoices_Year = table.Column<string>(type: "char(2)", nullable: false),
                    ...
                    NWC_Invoices_Service_Fee = table.Column<decimal>(type: "dec(10,2)", nullable: false),
                    NWC_Invoices_Tax_Rate = table.Column<decimal>(type: "dec(10,2)", nullable: false),
                    NWC_Invoices_Is_There_Sanitation = table.Column<string>(type: "varchar(6)", nullable: false),
                    NWC_Invoices_Consumption_Value = table.Column<decimal>(type: "dec(10,2)", nullable: false),
                    NWC_Invoices_Wastewater_Consumption_Value = table.Column<decimal>(type: "dec(10,2)", nullable: false),
                    NWC_Invoices_Total_Invoice = table.Column<decimal>(type: "dec(10,2)", nullable: false),
                    NWC_Invoices_Tax_Value = table.Column<decimal>(type: "dec(10,2)", nullable: false),
                    NWC_Invoices_Total_Bill = table.Column<decimal>(type: "dec(10,2)", nullable: false),
                    NWC_Invoices_Total_Reasons = table.Column<string>(type: "varchar(100)", nullable: true)
                },
                constraints: table =>
                {
